...
"use strict";
eval("\n\nvar _main2 = __webpack_require__(/*! ./main.js */ \"./lib/main.js\");\n\nvar _main3 = _interopRequireDefault(_main2);\n\n__webpack_require__(/*! babel-polyfill */ \"./node_modules/babel-polyfill/lib/index.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\ndocument.addEventListener('DOMContentLoaded', function () {\n    var canvas = document.getElementById(\"canvas\");\n    canvas.width = _main3.default.DIM_X;\n    canvas.height = _main3.default.DIM_Y;\n\n    var ctx = canvas.getContext('2d');\n\n    var form = document.getElementById(\"main-form\");\n    form.addEventListener(\"submit\", function (e) {\n        e.preventDefault();\n\n        var input = document.getElementById(\"number-of-simulations\");\n\n        if (input.value.length == 0) {\n            return;\n        }\n        var number_of_simulations = parseInt(input.value);\n\n        var type = document.querySelector('input[name=\"type\"]:checked').value;\n\n        if (type == \"viz\") {\n            var main = new _main3.default({ canvas: canvas, ctx: ctx, n_sites: _main3.default.N_SITES, number_of_simulations: number_of_simulations });\n            main.runSimulations();\n            main.disableSubmitButton();\n            main.clearStats();\n        } else {\n            var _main = new _main3.default({ n_sites: _main3.default.N_SITES, number_of_simulations: number_of_simulations });\n            _main.runNoVizSimulations();\n            // main.clearStats()\n        }\n    });\n});\n\n//# sourceURL=webpack:///./lib/entry.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _simpleStatistics = __webpack_require__(/*! simple-statistics */ \"./node_modules/simple-statistics/dist/simple-statistics.min.js\");\n\nvar ss = _interopRequireWildcard(_simpleStatistics);\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\n// for nodeJS\n// const ss = require(\"simple-statistics\");\n\nvar Stats = function () {\n    function Stats(nums) {\n        _classCallCheck(this, Stats);\n\n        this.nums = nums;\n        this.mean = null;\n        this.stnd_dev = null;\n        this.z_score = 1.960;\n    }\n\n    _createClass(Stats, [{\n        key: \"sampleMean\",\n        value: function sampleMean() {\n            this.mean = ss.mean(this.nums);\n            return this.mean;\n        }\n    }, {\n        key: \"standardDeviation\",\n        value: function standardDeviation() {\n            this.stnd_dev = ss.sampleStandardDeviation(this.nums);\n            return this.stnd_dev;\n        }\n    }, {\n        key: \"confidenceLow\",\n        value: function confidenceLow() {\n            return this.mean - this.z_score * (this.stnd_dev / Math.sqrt(this.nums.length));\n        }\n    }, {\n        key: \"confidenceHigh\",\n        value: function confidenceHigh() {\n            return this.mean + this.z_score * (this.stnd_dev / Math.sqrt(this.nums.length));\n        }\n    }, {\n        key: \"display\",\n        value: function display() {\n            var mean_view = document.getElementById(\"mean\");\n            var stnd_dev_view = document.getElementById(\"stnd-dev\");\n            var confidence_low = document.getElementById(\"confidence-low\");\n            var confidence_high = document.getElementById(\"confidence-high\");\n\n            mean_view.innerHTML = this.sampleMean();\n            stnd_dev_view.innerHTML = this.standardDeviation();\n            confidence_low.innerHTML = this.confidenceLow();\n            confidence_high.innerHTML = this.confidenceHigh();\n        }\n    }]);\n\n    return Stats;\n}();\n\nexports.default = Stats;\n\n//# sourceURL=webpack:///./lib/stats.js?");
...
/***/ 0:
/*!*******************************************!*\
  !*** multi babel-polyfill ./lib/entry.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! babel-polyfill */\"./node_modules/babel-polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! ./lib/entry.js */\"./lib/entry.js\");\n\n\n//# sourceURL=webpack:///multi_babel-polyfill_./lib/entry.js?");
