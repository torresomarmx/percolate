...
"use strict";
eval("\n\nvar _main = __webpack_require__(/*! ./main.js */ \"./lib/main.js\");\n\nvar _main2 = _interopRequireDefault(_main);\n\n__webpack_require__(/*! babel-polyfill */ \"./node_modules/babel-polyfill/lib/index.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\ndocument.addEventListener('DOMContentLoaded', function () {\n    var canvas = document.getElementById(\"canvas\");\n    canvas.width = _main2.default.DIM_X;\n    canvas.height = _main2.default.DIM_Y;\n\n    var ctx = canvas.getContext('2d');\n\n    var form_with_visualization = document.getElementById(\"simulations-form-with-viz\");\n    var form_without_visualization = document.getElementById(\"simulations-form-no-viz\");\n\n    form_with_visualization.addEventListener(\"submit\", function (e) {\n        e.preventDefault();\n        var input = document.getElementById('number-of-simulations-with-viz').value;\n\n        if (input.length == 0) {\n            return;\n        }\n\n        var main = new _main2.default(canvas, ctx, _main2.default.N_SITES, input);\n        main.runSimulations();\n    });\n\n    form_without_visualization.addEventListener(\"submit\", function (e) {\n        e.preventDefault();\n        var input = document.getElementById(\"number-of-simulations-no-ciz\");\n\n        if (input.length == 0) {\n            return;\n        }\n\n        var main = new _main2.default(input);\n        main.runNoVizSimulations();\n    });\n});\n\n//# sourceURL=webpack:///./lib/entry.js?");
