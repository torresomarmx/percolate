...
class Main{
    ...
    runFrame(){
        let random_open_site = this.current_sumulation.openRandomSite()
        if(this.current_sumulation.percolates()){
            this.current_sumulation.grid[random_open_site[0]][random_open_site[1]].fill_color = "blue";
            this.current_sumulation.grid[random_open_site[0]][random_open_site[1]].display(this.ctx);
